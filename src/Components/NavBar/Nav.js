      ...
      <div className="row">
        <div className="col-12 col-lg-6 logo-container">
          <div className="row p-2">
            <div className="col-6 text-center logo">WELLWALL</div>
            <div className="col-6 text-center hamb"><FaBars onClick={DropMenus} className="hamberger" /></div>
          </div>
        </div>
        <div className="col-12 col-lg-6 menu-container">
          <div className="row p-2">
            ...
            <div className="col-12 col-lg-3 text-center p-1">
              <Link to="/contact" className="H-link">Contact</Link>
              <span>
                <FaPhone className="phone-logo" />
              </span>
            </div>

            <div className="col-12 col-lg-3 text-center h-menu p-1" onClick={handleChange}>
              Works<span><FaSortDown className="down-arrow" /></span>
              <DropDown value={show} />
            </div>
          </div>
        </div>
